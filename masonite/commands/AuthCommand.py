...
class AuthCommand(Command):
    ...
    def handle(self):
        ...
        # move emails
        shutil.copytree(module_path + "/../snippets/auth/mail",
                        os.getcwd() + "/resources/templates/mail")

        self.info('Project Scaffolded. You now have 5 new controllers, 7 new templates, 1 new mail and 9 new routes')
